...
def gui():
    ...
    logo = customtkinter.CTkImage(light_image=Image.open(Constants.LOGO_IMAGE_PATH),
    ...
    # Text Label side bar
    side_title_label = customtkinter.CTkLabel(app, text="Manager Spese", fg_color="transparent", font=("Montserrat", 18))
    ...
    button_check_expense = customtkinter.CTkButton(app, text="Spesa Mensile", command=None)
